...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Overlay  */}
      { nav && <div  className="fixed md:hidden top-0 left-0 w-full h-screen bg-black/70 z-40" />}
      {/* Nav Menu */}
      <div className={ nav ? "fixed md:hidden top-0 left-0 h-screen w-[60%] sm:w-[40%] bg-white p-5  ease-in duration-300 overflow-scroll z-40" : "fixed md:hidden top-0 left-[-500px] h-screen w-[60%] bg-white p-5 ease-in duration-300 overflow-scroll z-40"}>
